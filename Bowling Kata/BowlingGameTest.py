...
class BowlingGameTest(unittest.TestCase):
    ...
    def test_should_return_frame_total_score(self):
        ...
        BowlingGame.frame_score(self, 2, 1, 4)
        BowlingGame.frame_score(self, 2, 2, 5)
        BowlingGame.frame_score(self, 3, 1, 6)
        BowlingGame.frame_score(self, 3, 2, 4)
        BowlingGame.frame_score(self, 4, 1, 5)
        BowlingGame.frame_score(self, 4, 2, 5)
        BowlingGame.frame_score(self, 5, 1, 10)
        BowlingGame.frame_score(self, 5, 2, 0)
        BowlingGame.frame_score(self, 6, 1, 0)
        BowlingGame.frame_score(self, 6, 2, 1)
        BowlingGame.frame_score(self, 7, 1, 7)
        BowlingGame.frame_score(self, 7, 2, 3)
        BowlingGame.frame_score(self, 8, 1, 6)
        BowlingGame.frame_score(self, 8, 2, 4)
        BowlingGame.frame_score(self, 9, 1, 10)
        BowlingGame.frame_score(self, 9, 2, 0)
        BowlingGame.frame_score(self, 10, 1, 2)
        BowlingGame.frame_score(self, 10, 2, 3)
        self.assertTrue(117, BowlingGame.get_score(10))
